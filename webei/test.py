...
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","host1","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",0)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","host2","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",0)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","host2","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",0)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","test_status1","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",1)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","test_status2","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",2)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","test_status3","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",3)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","test_status4","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",4)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","test_status4","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",4)')
c.execute('insert into ei_host(host_author,host_instance_name,host_type,host_version,host_ssh_ip,host_ssh_port,host_ssh_username,host_ssh_password,status) values("ddcw","test_status4","centos","7.6","127.0.0.1",22,"ygs","Ddcw@123.",4)')
